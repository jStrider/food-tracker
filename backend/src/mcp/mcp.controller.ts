...
export class McpController {
  ...
  @Get('tools')
  @ApiOperation({ summary: 'Get all available MCP tools for Claude integration' })
  @ApiResponse({ status: 200, description: 'List of available MCP tools with schemas' })
  getAvailableTools() {
  ...
  @Get('resources')
  @ApiOperation({ summary: 'Get all available MCP resources for Claude access' })
  ...
  @ApiParam({ name: 'resourceUri', description: 'URI of the resource to access' })
