...
describe('MealsService', () => {
  ...
  describe('findAll', () => {
    it('should return paginated meals', async () => {
      ...
      mockQueryBuilder.getManyAndCount.mockResolvedValue([mockMeals, mockTotal]);
    ...
    it('should include foods when requested', async () => {
      ...
      expect(mockQueryBuilder.leftJoinAndSelect).toHaveBeenCalledWith('meal.foods', 'foods');
      expect(mockQueryBuilder.leftJoinAndSelect).toHaveBeenCalledWith('foods.food', 'food');
    });
  });
  ...
  describe('findOne', () => {
    it('should return a meal by id', async () => {
      ...
      expect(mockQueryBuilder.where).toHaveBeenCalledWith('meal.id = :id', { id: '1' });
    });
  ...
  describe('findByDate', () => {
    it('should return meals for a specific date', async () => {
      ...
      expect(mockQueryBuilder.where).toHaveBeenCalledWith('meal.date = :date', { date: '2024-01-15' });
  ...
  describe('create', () => {
    ...
    it('should auto-categorize meal by time when category not provided', async () => {
      ...
      const mockMeal = { id: '1', ...createDto, category: MealCategory.BREAKFAST };
  ...
  describe('update', () => {
    ...
    it('should auto-categorize when time changes but category not provided', async () => {
      ...
      const existingMeal = { ...fixtures.meals.lunch, category: MealCategory.LUNCH };
    ...
    it('should update food entries', async () => {
      ...
      const existingMeal = fixtures.meals.breakfast;
      const existingEntries = [{ id: '1', mealId: '1', foodId: '1' }, { id: '2', mealId: '1', foodId: '2' }];
      ...
      expect(mockQueryRunner.manager.delete).toHaveBeenCalledWith(FoodEntry, ['2']);
