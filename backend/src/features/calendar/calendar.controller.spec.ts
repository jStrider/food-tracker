...
describe('CalendarController', () => {
  ...
  describe('getWeekViewWithGoals', () => {
    it('should return week view with goal progress', async () => {
      ...
      expect(result).toEqual(mockWeekData);
      expect(calendarService.getWeekView).toHaveBeenCalledWith('2024-01-15', goals);
    });
  });
  ...
  describe('getNutritionStreaks', () => {
    it('should return nutrition streaks with end date', async () => {
      const mockStreaks = {
        currentStreak: 5,
        longestStreak: 12,
        streakDates: ['2024-01-16', '2024-01-17', '2024-01-18', '2024-01-19', '2024-01-20'],
      };
      ...
      expect(calendarService.getNutritionStreaks).toHaveBeenCalledWith('2024-01-20');
    });
    ...
    it('should return nutrition streaks without end date', async () => {
      ...
      expect(result).toEqual(mockStreaks);
      expect(calendarService.getNutritionStreaks).toHaveBeenCalledWith(undefined);
    });
  });
  ...
  describe('getCalendarStats', () => {
    it('should return calendar statistics', async () => {
      ...
      const result = await controller.getCalendarStats('2024-01-01', '2024-01-31');

      expect(result).toEqual(mockStats);
      expect(calendarService.getCalendarStats).toHaveBeenCalledWith('2024-01-01', '2024-01-31');
    });
  });
});