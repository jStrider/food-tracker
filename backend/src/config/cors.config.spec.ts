...
describe('CORS Configuration', () => {
  ...
  describe('Development environment', () => {
    ...
    it('should include default development origins', () => {
      ...
      const origin = config.origin as Function;
  ...
  describe('Production environment', () => {
    ...
    it('should only allow configured origins', () => {
      process.env.ALLOWED_ORIGINS = 'https://app.foodtracker.com,https://www.foodtracker.com';
  ...
  describe('Origin parsing', () => {
    it('should handle multiple origins with spaces', () => {
      process.env.NODE_ENV = 'production';
      process.env.ALLOWED_ORIGINS = 'https://app.foodtracker.com, https://www.foodtracker.com , https://api.foodtracker.com';
