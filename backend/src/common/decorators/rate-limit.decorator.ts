...
import { RATE_LIMIT_CATEGORIES, RateLimitCategory } from "../../config/rate-limit.config";
...
export const MutationRateLimit = () => RateLimit(RATE_LIMIT_CATEGORIES.MUTATION);
export const QueryRateLimit = () => RateLimit(RATE_LIMIT_CATEGORIES.QUERY);
export const ExpensiveRateLimit = () => RateLimit(RATE_LIMIT_CATEGORIES.EXPENSIVE);
